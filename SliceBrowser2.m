...
if (handles.color_mode ==1)
    sliceXY = squeeze(handles.volume(:,:,handles.pointer3dt(3),1:3));
    sliceYZ = squeeze(handles.volume(handles.pointer3dt(1),:,:,1:3));
    sliceXZ = squeeze(handles.volume(:,handles.pointer3dt(2),:,1:3));
